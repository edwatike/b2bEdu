        ...
        <div className="grid gap-6 lg:grid-cols-1">
          <Card className="bg-slate-900/60 border-slate-700">
            ...
            <CardContent className="space-y-4">
              ...
              {hasError && (
                <p className="text-sm text-rose-200">Не удалось загрузить статистику. Попробуйте позже.</p>
              )}
              <Button className="w-full" variant="secondary" onClick={handleCreateRequest}>
                Создать заявку
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
              <Button className="w-full" variant="outline" onClick={() => router.push("/cabinet/requests/all")}>
